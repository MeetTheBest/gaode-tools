...
import { LikeRectangle, ILikeRectangleOptions, LikeRectangleEditor } from '../../src/main';
...
const createLikeRectangleEditor = () => {
	likeRectangleEditorIns = new LikeRectangleEditor(mapIns!, likeRectangleIns as LikeRectangle);
